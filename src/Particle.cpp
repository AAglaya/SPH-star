...
/*
void Particle::set_acceleration(Vec_1d<double> new_acceleration) {
    acceleration = new_acceleration;
}

void Particle::inc_acceleration(Vec_1d<double> delta_acceleration) {
    for (int k = 0; k < 2; k++) acceleration[k] += delta_acceleration[k];
}
*/
